...
public final class StartupBanner {
    ...
    /** Version from the containing jar's manifest, or {@code beta-2.0} when unavailable (IDE runs). */
    private static String resolveVersion() {
        try {
            Package pkg = StartupBanner.class.getPackage();
            String version = pkg == null ? null : pkg.getImplementationVersion();
            return version != null ? version : "ZstdNetworkProject beta-2.0";
        } catch (Throwable t) {
            return "ZstdNetworkProject beta-2.0";
        }
    }
