...
| Módulo | Archivo |
|---|---|
| NeoForge | `zstd-neoforge-beta-0.7-mc<version>.jar` |
| Fabric | `zstd-fabric-beta-0.7-mc<version>.jar` |
| Paper | `zstd-paper-beta-0.7-mc<version>.jar` |
| Velocity | `zstd-velocity-beta-0.7.jar` |
...
El plugin/proxy está optimizado para servidores Linux y contenedores Docker (hostings compartidos):
